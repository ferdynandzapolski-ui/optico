...
| :--- | :--- | :--- |
| `Node` | `std/ir/node.oco` | Base AST node structure (10 fields) with `PtrVector` children, graph pointers (`parent`, `next`), source locations, 128-bit `Fingerprint`, and `Durability` level. |
